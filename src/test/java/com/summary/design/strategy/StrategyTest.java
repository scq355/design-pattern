package com.summary.design.strategy;

import com.summary.design.strategy.base_2.CashFactory;
import com.summary.design.strategy.base_2.CashSuper;
import com.summary.design.strategy.base_3.CashContext;
import com.summary.design.strategy.base_3.CashNormal;
import com.summary.design.strategy.base_3.CashRebate;
import com.summary.design.strategy.base_3.CashReturn;
...
public class StrategyTest {
    ...
    private static void strategyAndSimpleFactoryTest() {
        Double total = 0.0;
        com.summary.design.strategy.base_4.CashContext cashContext = new com.summary.design.strategy.base_4.CashContext("打8折");
        Double totalprices = cashContext.getResult(1000.0);
        total += totalprices;
